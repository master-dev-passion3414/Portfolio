...
[![GitHub stars](https://img.shields.io/github/stars/master-dev-passion3414/NodeJs-Portfolio-Billy?style=social)](https://github.com/master-dev-passion3414/NodeJs-Portfolio-Billy/stargazers) [![Latest Release](https://img.shields.io/github/v/release/asma019/NodeJs-Portfolio-Billy?style=flat-square)](https://github.com/master-dev-passion3414/NodeJs-Portfolio-Billy/releases/tag/v)
...
1. Clone the repository:
   ```bash
   git clone https://github.com/master-dev-passion3414/NodeJs-Portfolio-Billy-Hasan.git
   cd NodeJs-Portfolio-Billy-Hasan
   ```
...
[![Deploy to Heroku](https://www.herokucdn.com/deploy/button.svg)](https://heroku.com/deploy?template=https://github.com/master-dev-passion3414/NodeJs-Portfolio-Billy-Hasan)
...
[![Deploy with Vercel](https://vercel.com/button)](https://vercel.com/new/clone?repository-url=https://github.com/master-dev-passion3414/NodeJs-Portfolio-Billy-Hasan)
...
Check out the [latest release](https://github.com/master-dev-passion3414/NodeJs-Portfolio-Billy-Hasan/releases/tag/v) for the most up-to-date version.
...
2. Generate the PDF:
```bash
mdpdf CV.md --style cv-style.css --output Billy_Hasan_CV.pdf
```
...
⭐ **If you find this project useful, please consider [giving it a star on GitHub](https://github.com/master-dev-passion3414/NodeJs-Portfolio-Billy-Hasan)!** ⭐

Built with ❤️ by [Billy Kelley](https://github.com/master-dev-passion3414)
