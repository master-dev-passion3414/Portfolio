  ...
  const educationHistory = [
    {
      ...
      period: "2023 - 2026",
      description: "Designed scalable AWS architectures with focus on cloud infrastructure, application performance, security, storage, networking, and cost optimization.",
    },
    {
      degree: "Bachelor of Computer Science",
      institution: "Fayetteville State University",
      period: "2006 - 2010",
      description: "Built a strong foundation in software engineering, algorithms, databases, systems design, and application development.",
    },
  ];

  const readings = [
    "Advanced AI/ML Software Design",
          ...
          >
            ...
            <div className="bg-white dark:bg-gray-800 p-8 rounded-xl shadow-lg hover:shadow-xl transition-shadow duration-300 border border-gray-100 dark:border-gray-700">
              ...
              >
                ...
                <p className="text-gray-600 dark:text-gray-300">
                  My goal is to build high-performing, user-focused digital experiences that combine thoughtful design with strong technical execution. 
                  I am passionate about creating modern websites and web applications across e-commerce, healthcare, automotive and professional services, 
                  while continuously exploring AI and emerging technologies to make digital products smarter, faster and more effective.
                </p>
              </motion.div>
            </div>
          </motion.div>
