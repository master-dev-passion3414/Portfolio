...
const Testimonials = () => {
  ...
  const testimonials = [
      ...
      company: "MngMate",
      image: "/images/Jaime Marrugo.jpg",
      text: "Billy was a tremendous help during the development and review process of MngMate. He took the time to thoroughly evaluate our platform, identify areas for improvement, and provide clear, actionable feedback that helped move the project forward.",
      rating: 5,
    },
    {
      id: 2,
      ...
      text: "Working with Billy was a great experience. He understood our requirements perfectly and delivered a solution that perfectly matched our vision. His communication throughout the project was excellent.",
      rating: 5,
    },
    {
      id: 3,
      ...
      text: "Billy is a talented developer who consistently delivers high-quality work. He helped us develop a complex web application with multiple integrations, and the result was exactly what we needed.",
      rating: 5,
    },
    {
      id: 4,
      ...
      text: "We hired Billy to develop our e-commerce platform, and he delivered an outstanding result. His technical skills and problem-solving abilities made our project a success. Highly recommended!",
      rating: 5,
    },
    {
      id: 5,
      ...
      text: "Billy delivered exceptional work for our website redesign. His attention to detail and technical expertise exceeded our expectations. The website is not only visually appealing but also performs excellently across all devices.",
      rating: 5,
    },
  ];
