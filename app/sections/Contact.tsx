...
const Contact = () => {
  const formName = "BillyMS"; // Form name to keep it consistent with the API
  ...
  const contactInfo = [
    {
      icon: <FiMail size={22} />,
      label: "Email",
      value: "kelleybilly988@gmail.com",
      link: "mailto:kelleybilly988@gmail.com",
    },
    {
      icon: <FiPhone size={22} />,
      label: "Phone",
      value: "+1 (907) 750-6960",
      link: "tel:+19077506960",
    },
    {
      icon: <FiMapPin size={22} />,
      label: "Location",
      value: "528 McNeill St, Lumberton, NC 28358, USA",
      link: "https://maps.app.goo.gl/5bw5M15uNMzS1ERk6",
    },
  ];
          ...
          >
            ...
            >
              ...
              <div className="flex space-x-4">
                ...
                <a
                  href="https://www.linkedin.com/in/billy-kelley-a0075984"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="h-12 w-12 rounded-lg bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 shadow-sm flex items-center justify-center text-gray-700 dark:text-gray-300 hover:border-blue-500 hover:text-blue-600 dark:hover:text-blue-400 transition-all hover:-translate-y-1"
                  aria-label="LinkedIn"
