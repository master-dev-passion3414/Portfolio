        ...
        <div className="flex flex-col md:flex-row justify-between items-center mb-10">
          <div className="mb-8 md:mb-0 text-center md:text-left">
            <div className="flex items-center justify-center md:justify-start mb-3">
              <Logo showText={false} />
              <h2 className="text-2xl font-bold ml-3">Billy Kelley</h2>
            </div>
            ...
            <div className="flex flex-wrap justify-center md:justify-start gap-4 mt-4">
              ...
              <a
                href="mailto:hello@mehedims.com"
                className="w-10 h-10 rounded-full bg-gray-800 flex items-center justify-center text-gray-400 hover:bg-blue-600 hover:text-white transition-colors duration-300"
                aria-label="Email"
              >
                <FiMail size={18} />
              ...
              <a
                href="https://maps.google.com/?q=Khulna+University+Khulna+United States"
                target="_blank"
                rel="noopener noreferrer"
                className="w-10 h-10 rounded-full bg-gray-800 flex items-center justify-center text-gray-400 hover:bg-blue-600 hover:text-white transition-colors duration-300"
                aria-label="Location"
          ...
          <div className="grid grid-cols-2 gap-8 sm:gap-16">
            ...
            <div className="text-center sm:text-left">
              ...
              <nav className="flex flex-col space-y-2">
                ...
                <a 
                  href="https://github.com/master-dev-passion3414/NodeJs-Portfolio-Billy-Hasan" 
                  target="_blank" 
                  rel="noopener noreferrer"
        ...
        <div className="relative border-t border-gray-800 mt-8 pt-8 flex flex-col sm:flex-row justify-between items-center">
          <div className="flex flex-col items-center sm:items-start mb-4 sm:mb-0">
            <p className="text-gray-400 text-sm mb-2">
              &copy; {currentYear} Billy Kelley. All rights reserved.
