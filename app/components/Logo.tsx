  ...
  return (
    <Link href="/" className="font-bold text-gray-800 dark:text-white flex items-center group">
      <div className="relative flex items-center justify-center">
        ...
        >
          <span className="text-white text-lg sm:text-xl font-bold">BK</span>
        </motion.div>
        <motion.div 
      ...
      {showText && !isMobile && (
        ...
        >
          <span className="text-lg font-bold tracking-tight">Billy Kelley</span>
          <span className="text-xs text-gray-500 dark:text-gray-400 font-medium">Full Stack Web Developer</span>
        </motion.div>
      )}
    </Link>
  );
